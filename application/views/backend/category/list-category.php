                                ...
                                <table class="table table-bordered table-striped dataTable" id="example1" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($arr_categary_list as $row) {
                                            ...
                                            <tr>
                                                <td align="left">
                                        <center><input name="checkbox[]" class="case" type="checkbox" id="checkbox" value="<?php echo $row['category_detail_id']; ?>" /></center>
                                        </td>
                                        <td  align="left"><?php echo stripslashes($row['category_name']); ?></td>
                                        <td  align="left"><?php echo stripslashes(substr($row['category_description'], 0, 500)); ?></td>
