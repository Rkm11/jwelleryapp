        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">                    
                        <div class="box-body">
                            <form name="frm_add_category" enctype="multipart/form-data"  id="frm_add_category" action="<?php echo base_url(); ?>backend/category/add-category" method="POST" >			
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" id="category_description" name="category_description" class="form-control" ></textarea>
                            </div>
