                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                if ($arr_global_settings['name'] == "date_format") {
                                    ...
                                    ?>
                                    <textarea name="value" class="form-control" id="value"><?php echo htmlentities(stripslashes($arr_global_settings['value'])); ?></textarea>
                                <?php
                                } else {
                                    ?>
...
if ($arr_global_settings['name'] == "facebook_link" || $arr_global_settings['name'] == "twitter_link" || $arr_global_settings['name'] == "Google+_link" || $arr_global_settings['name'] == "pinterest_link" || $arr_global_settings['name'] == "Linkedin_link" || $arr_global_settings['name'] == "link1" || $arr_global_settings['name'] == "link2" || $arr_global_settings['name'] == "link3" || $arr_global_settings['name'] == "link4" || $arr_global_settings['name'] == "link5" || $arr_global_settings['name'] == "link6") {
    echo ",url:true";
}
?>
...
if ($arr_global_settings['name'] == "pinterest_link") {
    echo'url:"Please enter valid link."';
}

if ($arr_global_settings['name'] == "link1") {
    echo'url:"Please enter valid link."';
}
if ($arr_global_settings['name'] == "link2") {
    echo'url:"Please enter valid link."';
}
