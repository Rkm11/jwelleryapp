...
<aside class="right-side">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><?php echo (isset($edit_id) && $edit_id != "") ? "Update" : "Add"; ?> FAQ</li>
                    ...
                    <form name="frmFaqs" id="frmFaqs"  action="<?php echo base_url(); ?>backend/faqs/add" method="POST">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="6"  class="form-control" name="input_answer" ><?php echo stripslashes(isset($arr_faq['answer']) ? $arr_faq['answer'] : '') ?></textarea>
                            </div>
                            <?php if (isset($edit_id) && $edit_id = !'') { ?>
                                <div class="form-group">
                                    <label for="parametername">Created on<sup class="mandatory">*</sup></label>
