        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    <form  name="edit_country_form" id="edit_country_form" action="<?php echo base_url(); ?>backend/countries/edit-country/<?php echo $arr_country_details[0]['country_id']; ?>" method="post">
                        <div class="box-body">
