...
<script src="<?php echo base_url(); ?>media/front/js/datepicker/jquery-ui.js"></script>
<!--<script src="<?php echo base_url(); ?>media/front/js/ckeditor/ckeditor.js"></script>-->
...
<script src="<?php echo base_url(); ?>media/front/js/customize/product.js"></script>
<!-- Morris.js charts -->
<!-- DATA TABES SCRIPT -->
...
<script src="<?php echo base_url(); ?>media/backend/js/select-all-delete.js"></script>      
	...
	<script src="<?php echo base_url(); ?>media/backend/js/mootools-more-1.4.0.1.js"></script>
	<script src="<?php echo base_url(); ?>media/backend/js/chosen.js"></script>
	<script src="<?php echo base_url(); ?>media/backend/js/Locale.en-US.Chosen.js"></script>
