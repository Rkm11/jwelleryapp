...
<!--                <li <?php if ($this->uri->segment(2) == 'admin') { ?> class="active" <?php } ?>>
                ...
                <li class="treeview <?php if ($this->uri->segment(2) == 'user') { ?> active<?php } ?>" <?php if ($this->uri->segment(2) == 'user') { ?> class="active" <?php } ?>>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url(); ?>backend/user/list"><i class="fa fa-angle-double-right"></i> View Customers</a></li>
                        <li><a href="<?php echo base_url(); ?>backend/user/w-list"><i class="fa fa-angle-double-right"></i> View Whole seller</a></li>
...
<!--                <li  <?php if ($this->uri->segment(2) == 'notification-template' || $this->uri->segment(2) == 'edit-notification-template') { ?> class="active" <?php } ?>>
                    <a href="<?php echo base_url(); ?>backend/notification-template/list">
                        <i class="fa fa-fw fa-envelope"></i> <span>Manage notification Templates</span> 
                    </a>
                </li>
...
<!--                <li <?php if ($this->uri->segment(2) == 'orders') { ?> class="active" <?php } ?>>
                    <a href="<?php echo base_url(); ?>backend/orders/list">
                        <i class="fa fa-fw fa-retweet"></i> <span>Manage orders</span> 
                    </a>
                </li>-->
                <li <?php if ($this->uri->segment(2) == 'categories') { ?> class="active" <?php } ?>>
                    <a href="<?php echo base_url(); ?>backend/categories/list">
                        <i class="fa fa-fw fa-list"></i> <span>Manage Categories</span> 
                    </a>
                </li>
...
<!--                <li  <?php if ($this->uri->segment(2) == 'slider-banner') { ?> class="active" <?php } ?>>
                ...
                <li <?php if ($this->uri->segment(2) == 'products' ||$this->uri->segment(2) == 'product' ) { ?>class="active"<?php } ?> >
                ...
                <li <?php if ($this->uri->segment(2) == 'inquiries' ||$this->uri->segment(2) == 'inquiries' ) { ?>class="active"<?php } ?> >
                    <a href="<?php echo base_url(); ?>backend/inquiries/list">
                        <i class="fa fa-fw fa-money"></i>
                        <span>Manage Products Inquiries</span>
                    </a>
                </li>
                <li <?php if ($this->uri->segment(2) == 'carat' ||$this->uri->segment(2) == 'carat' ) { ?>class="active"<?php } ?> >
                    <a href="<?php echo base_url(); ?>backend/carat/list">
                        <i class="fa fa-fw fa-money"></i>
                        <span>Manage Carat Details</span>
                    </a>
                </li>
...
<!--                                <li class="treeview <?php if ($this->uri->segment(2) == 'newsletter' || $this->uri->segment(2) == 'newsletter-subscriber') { ?>active<?php } ?>" <?php if ($this->uri->segment(2) == 'newsletter') { ?> class="active" <?php } ?>>
                                    ...
                                    <ul class="treeview-menu"> <li><a href="<?php echo base_url(); ?>backend/newsletter/list"><i class="fa fa-fw fa-list"></i> View Newsletters</a></li>
                                        <li <?php if ($this->uri->segment(2) == 'newsletter-subscriber') { ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>backend/newsletter-subscriber/list"><i class="fa fa-fw fa-user"></i> Manage Newsletters Subscribers</a></li>
...
<!--                                <li  <?php if ($this->uri->segment(2) == 'slider-banner') { ?> class="active" <?php } ?>>
                            ...
                            case 14:
                                ?>	
<!--                                <li class="treeview <?php if ($this->uri->segment(2) == 'advertises' || $this->uri->segment(2) == 'advertise-categories') { ?>active<?php } ?>" <?php if ($this->uri->segment(2) == 'advertises') { ?> class="active" <?php } ?>>
                                    <a href="<?php echo base_url(); ?>backend/advertises">
                                        <i class="fa fa-fw fa-money"></i>
                                        <span>Manage Advertise</span>
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li <?php if ($this->uri->segment(2) == 'advertise-categories') { ?> class="active" <?php } ?>>
                                            <a href="<?php echo base_url(); ?>backend/advertises"><a href="<?php echo base_url(); ?>backend/advertise-categories"><i class="fa fa-fw fa-list"></i> Advertise Categories</a></li>
                                        <li >
                                            <a href="<?php echo base_url(); ?>backend/advertises"><a href="<?php echo base_url(); ?>backend/advertises"><i class="fa fa-fw fa-list"></i> View Advertise </a></li>
                            ...
                            case 15:
                                ?>	
<!--                                <li  class="treeview <?php if ($this->uri->segment(2) == 'blog' || $this->uri->segment(2) == 'blog-category') { ?>active<?php } ?>" <?php if ($this->uri->segment(2) == 'blog') { ?> class="active" <?php } ?>>
                                    <a href="#">
                                        <i class="fa fa-fw fa-rss"></i>
                                        <span>Manage Blogs</span>
                                        <i class="fa fa-angle-left pull-right"></i>
