                            ...
                            <div role="grid" class="dataTables_wrapper form-inline" id="example1_wrapper">									
                                <table class="table table-bordered table-striped dataTable" id="example1" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <!--<td ><?php echo stripslashes($user['user_name']); ?></td>-->
                                        ...
                                        <td class="worktd"><a class="btn btn-info" title="Edit User Details" href="<?php echo base_url(); ?>backend/user/edit/<?php echo base64_encode($user['user_id']); ?>"> <i class="icon-edit icon-white"></i>Edit</a> <a class="btn btn-primary" title="View User Details" href="<?php echo base_url(); ?>backend/user/view/<?php echo base64_encode($user['user_id']); ?>"> <i class="icon-edit icon-white"></i>View</a></td>
                                        <?php
                                    }
                                    ?>
                                    </tbody>
