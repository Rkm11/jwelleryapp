...
<aside class="right-side">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>backend/logistics/TNT"><i class="fa fa-fw fa-legal"></i> Logistic Management TNT</a></li>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == "truedone") {
                        window.location.replace("<?php echo base_url(); ?>backend/logistics/TNT");
