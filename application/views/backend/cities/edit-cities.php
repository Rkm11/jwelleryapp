                            ...
                            <div class="form-group">
                                ...
                                <select id="country_id" name="country_id" class="form-control" onChange="updateStateInfo(this.value);" >
                                    ...
                                    <?php foreach ($arr_county_details as $row) { ?>
                                        <option value="<?php echo $row['country_id'] ?>" <?php echo($arr_city_details[0]['country_id_fk'] == $row['country_id']) ? 'selected="selected"' : ''; ?>><?php echo $row['country_name'] ?></option>
                                    <?php } ?>
                                </select>
                                ...
                                <div class="Religion" id="state_div">
                                    ...
                                    <select id="state_id" name="state_id" class="form-control" >
                                        <?php foreach ($arr_state_details as $row) { ?>
                                            <option value="<?php echo $row['state_id']; ?>" <?php echo($arr_city_details[0]['state_id_fk'] == $row['state_id']) ? 'selected="selected"' : ''; ?>><?php echo $row['state_name']; ?></option>
                                        <?php } ?>                               
                                    </select>   
                                </div>
