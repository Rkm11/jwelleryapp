                    ...
                    <form name="frm_add_newsletter" id="frm_add_newsletter" action="<?php echo base_url(); ?>backend/newsletter/edit/<?php echo $arr_newsletter_data['newsletter_id']; ?>" method="post" >
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  class="ckeditor" class="form-control" name="input_content" id="input_content"><?php echo set_value('input_content'); ?><?php echo stripslashes($arr_newsletter_data['newsletter_content']); ?></textarea>
