                    ...
                    <form name="form_reply" id="form_reply"  action="<?php echo base_url() . 'backend/contact-us/reply/' . base64_encode($arr_contact[0]['contact_id']); ?>" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" size="80" id="from_name" value="<?php echo $global['site_title']; ?>" name="from_name" class="form-control">

                            </div>
                            <div class="form-group">
                                <label for="parametername">From Email :<sup class="mandatory">*</sup></label>
                                <input type="text" value="<?php echo $global['contact_email']; ?>" name="from_email" class="form-control">

                            </div>
                            <div class="form-group">
                                <label for="parametername">Subject :<sup class="mandatory">*</sup></label>
                                <input type="text" value="<?php echo 'Reply:' . $arr_contact[0]['subject']; ?>" name="subject" class="form-control">

                            </div>
                            <div class="form-group">
                                <label for="parametername">Message :<sup class="mandatory">*</sup></label>
                                <textarea name="message" id="message"   rows="10" class="form-control"><?php echo $message; ?></textarea>
