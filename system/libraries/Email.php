...
class CI_Email {
	...
	var	$smtp_host		= "cp-28.webhostbox.net";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "karmadev2016@gmail.com";		// SMTP Username
	var	$smtp_pass		= "Karma@2016";		// SMTP Password
